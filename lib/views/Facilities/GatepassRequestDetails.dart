...
class GatepassRequestDetails extends StatefulWidget {
  ...
  GatepassRequestDetails(this.regNo, this.name, this.roomNo, this.branch,
...
class GatepassRequestDetailsState extends State<GatepassRequestDetails> {
  ...
  deleteRequest() {
    databaseMethods.deleteGatepassRequest(widget.regNo);
    ...
    databaseMethods.acceptGatepassRequest(widget.regNo, gatepassDetails);
